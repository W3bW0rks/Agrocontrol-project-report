  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <em>TF:</em> La capacidad para comunicar oralmente los desarrollos del frontend y la landing page a nuestro equipo y asesores fue esencial para mantener una visión compartida del proyecto, asegurando que todos comprendieran los objetivos y las metas planteadas durante las reuniones.<br><br>
        ...
        <em>TP:</em> Al diseñar e implementar formularios y vistas del proyecto, presenté informes claros que destacan los avances de este. Durante reuniones de seguimiento, fomenté la retroalimentación, asegurando que mis compañeros entiendan la importancia de cada componente, para fortalecer colaboración y el compromiso con los objetivos del proyecto.<br><br>
        ...
        <em>TF:</em> Al describir tanto las funcionalidades del frontend como del backend, logré transmitir con claridad y objetividad las ideas y los resultados del desarrollo a nuestro grupo de trabajo, permitiendo una colaboración más efectiva durante las reuniones regulares.<br><br>
        ...
        <em>TB2:</em> Para esta entrega, presenté las nuevas user stories relacionadas con el backend. En particular, abordé mis tareas en los contextos de IAM y Profile, destacando la implementación de aspectos de seguridad como JWT, la encriptación de contraseñas y la protección de rutas mediante guard. En reuniones técnicas, adapté la explicación para que los miembros del equipo pudieran entender el rol de estos elementos en la seguridad y su impacto en la integración del sistema. Esta comunicación efectiva ayudó a lograr una comprensión compartida de las medidas de seguridad implementadas.<br><br>
        <em>TF:</em> Expresar de manera eficaz y objetiva las actualizaciones del frontend y backend permitió a nuestro equipo alinear sus esfuerzos, asegurando que los objetivos fueran claros y precisos para todos los involucrados.<br><br>
        ...
        <em>TF:</em> La comunicación clara de ideas y resultados en un entorno de formación académica fue fundamental para asegurar que nuestro equipo joven lograra una comprensión compartida y ejecutara los entregables de manera efectiva.<br><br>
        ...
        <em>TF:</em> La comunicación verbal precisa con nuestro equipo de estudiantes mejoró el entendimiento del sistema y fortaleció el desarrollo colaborativo del proyecto desarrollado.<br><br>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        ...
        <em>TF:</em> La creación de documentación clara y directa sobre el desarrollo del frontend y la landing page aseguró que los compañeros del startup estuvieran informados y alineados con los objetivos del proyecto.<br><br>
        <strong>Johan Príncipe:</strong><br>
        ...
        <em>TP:</em> Redacté los informes de progreso sobre el diseño de formularios y vistas, presenté las mejoras del proyecto para que sean comprensibles. Esto facilita la toma de decisiones y asegura que todos estén alineados con los objetivos del proyecto.<br><br>
        ...
        <em>TF:</em> La documentación escrita detalló claramente los desarrollos del frontend y backend, facilitando el trabajo colaborativo y asegurando que el equipo compartiera una perspectiva unificada de los avances del proyecto.<br><br>
        <strong>André Arroyo:</strong><br>
        ...
        <em>TF:</em> La documentación técnica del frontend y backend fue detallada y precisa, garantizando que todos los participantes del proyecto comprenderían los componentes tecnológicos y alineaban los esfuerzos hacia un objetivo común en nuestro entorno universitario.<br><br>
        <strong>Alejandro Espino Flores:</strong><br>
        ...
        <em>TF:</em> La redacción de reportes claros y organizados en el desarrollo del proyecto permitió que tanto estudiantes como mentores integraran mejor sus conocimientos, garantizando que los objetivos académicos y técnicos avanzaran juntos efectivamente.<br><br>
        <strong>Hardie Holguin:</strong><br>
        ...
        <em>TF:</em> La elaboración cuidadosa de documentación escrita aseguró que todos los miembros del equipo, al igual que nuestros guías académicos, estuvieran en sintonía y entendieran claramente las funcionalidades y la estructura del sistema en desarrollo.<br><br>
      </td>
      <td width="200px">
