...
|E6-US102|Registrar usuario atraves de la APIRESTful|**Como** desarrollador **quiero** registrar al usuario atraves de la API **para** persistir su informacion en la base de datos|<p>**Escenario 1: Registrar Productor Agricola**</p><p>**Dado que** el endpoint "/api/v1/sing-up/agricultural-producer esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos:nombre completo, correo, contraseña, ciudad, pais, numero celular, rol y dni </p><p>**Entonces** recibe una respuesta con estado 201 con el mensaje "El productor agricola ha sido registrado exitosamente"</p><p>**Escenario 2: Registrar Distribuidor**</p><p>**Dado que** el endpoint "/api/v1/sing-up/distributor esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos:nombre completo, correo, contraseña, ciudad, pais, numero celular, rol, nombre de la compañia y numero RUC </p><p>**Entonces** recibe una respuesta con estado 201 con el mensaje "El distribuidor ha sido registrado exitosamente"</p>|6|
|E6-US103|Iniciar sesion del usuario atraves de la APIRESTful|**Como** desarrollador **quiero** logear al usuario atraves de la API **para** brindarle acceso a la aplicación|<p>**Escenario 1: Logear Usuario**</p><p>**Dado que** el endpoint "api/v1/sign-in esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: correo y contraseña</p><p>**Entonces** recibe una respuesta con estado 201 y recibe un recurso con los sigueintes datos: id, correo, rol y json web token </p>|6|
|E6-US104|Obtener informacion del usuario atraves de la APIRESTful|**Como** desarrollador **quiero** obtener informacion del usuario atraves de la API **para** mostrar los datos en la aplicación|<p>**Escenario 1: Obtener informacion del Productor agricola**</p><p>**Dado que** el endpoint "api/v1/profile/agricultural-producer/{userId} esta disponible</p><p>**Cuando** envia la solicitud GET con los siguientes datos: userId</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso productor agricola con los sigueintes datos: nombre completo, correo, ciudad, pais, numero celular y dni</p><p>**Escenario 1: Obtener informacion del Distribuidor**</p><p>**Dado que** el endpoint "api/v1/profile/distributor/{userId} esta disponible</p><p>**Cuando** envia la solicitud GET con los siguientes datos: userId</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso distribuidor con los sigueintes datos: nombre completo, ciudad, pais, numero celular, nombre de la compañia y numero RUC</p>|6|
|E6-US105|Crear plantación atraves de la APIRESTful|**Como** desarrollador **quiero** crear la plantacion atraves de la API **para** registrarlo en la base de datos |<p>**Escenario 1: Crear Plantación**</p><p>**Dado que** el endpoint "api/v1/seeding esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: userID, nombre de la semilla, cantidad de la semilla, costo total de las semillas y nombre de los trabajadores</p><p>**Entonces** recibe una respuesta con estado 201 y recibe un recurso seeding con los sigueintes datos: id, userID y nombre de la planta</p>|6|
|E6-US106|Obtener informacion de la plantación atraves de la APIRESTful|**Como** desarrollador **quiero** obtener la informacion de la plantación atraves de la API **para** mostrar los datos en la aplicación |<p>**Escenario 1: Obtener informacion Plantación**</p><p>**Dado que** el endpoint "api/v1/seeding/{seedingId} esta disponible</p><p>**Cuando** envia la solicitud GET con los siguientes datos:id</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso seeding con los sigueintes datos: nombre de la semilla, cantidad de la semilla, costo total de las semillas, startDate y finishDate</p>|6|
|E6-US107|Terminar la plantación atraves de la APIRESTful|**Como** desarrollador **quiero** terminar la plantacion atraves de la API **para** mostrar los datos en la aplicación |<p>**Escenario 1: Obtener informacion Plantación**</p><p>**Dado que** el endpoint "api/v1/seeding/finish-plantation/{seedingId} esta disponible</p><p>**Cuando** envia la solicitud PUT con los siguientes datos: seedingId, finishDate</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso seeding con los sigueintes datos: seedingId, finishDate</p>|6|
|E6-US108|Agregar trabajador atraves de la APIRESTful|**Como** desarrollador **quiero** agregar trabajadores atraves de la API **para** registrarlo en la base de datos|<p>**Escenario 1: Agregar Trabajadores**</p><p>**Dado que** el endpoint "api/v1/worker esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: agriculturalProcessId, nombre, numero celular, area de trabajo</p><p>**Entonces** recibe una respuesta con estado 201 con el mensaje "El trabajador ha sido creado exitosamente"</p>|6|
|E6-US109|Obtener trabajador atraves de la APIRESTful|**Como** desarrollador **quiero** obtener información de los trabajadores atraves de la API **para** registrarlo en la base de datos|<p>**Escenario 1: Obtener informacion de los trabajadores**</p><p>**Dado que** el endpoint "api/v1/worker/{agriculturalProcessId} esta disponible</p><p>**Cuando** envia la solicitud GET con los siguientes datos: agriculturalProcessId</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso worker con los siguientes datos: workerId,nombre completo, numero celular, area de trabajo</p>|6|
|E6-US110|Eliminar Trabajador atraves de la APIRESTful|**Como** desarrollador **quiero** eliminar trabajadores atraves de la API **para** eliminar los datos en la aplicación|<p>**Escenario 1: Eliminar trabajador**</p><p>**Dado que** el endpoint "api/v1/worker/{workerId} esta disponible</p><p>**Cuando** envia la solicitud DELETE con los siguientes datos:id</p><p>**Entonces** recibe una respuesta con estado 200 con el mensaje "El trabajador ha sido eliminado exitosamente"</p>|6|
|E6-US111|Editar Trabajador atraves de la APIRESTful|**Como** desarrollador **quiero** editar la informacion de los trabajadores atraves de la API **para** mostrar la modificación de datos en la aplicación|<p>**Escenario 1: Editar informacion del trabajador**</p><p>**Dado que** el endpoint "api/v1/worker/{workerId} esta disponible</p><p>**Cuando** envia la solicitud PUT con los siguientes datos: nombre completo, numero celular, area de trabajo</p><p>**Entonces** recibe una respuesta con estado 200 con el mensaje "La información del trabajador ha sido editada exitosamente"</p>|6|
|E6-US112|Crear fechas de irrigación atraves de la APIRESTful|**Como** desarrollador **quiero** crear fechas de irrigación atraves de la API **para** registrarlo en la base de datos|<p>**Escenario 1: Crear fechas de irrigación**</p><p>**Dado que** el endpoint "api/v1/irrigation esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: agriculturalProcessId, date, hours, workers, cost</p><p>**Entonces** recibe una respuesta con estado 201 con el mensaje "La fecha de irrigacion ha sido creada exitosamente"</p>|6|
|E6-US113|Obtener fechas de irrigación atraves de la APIRESTful|**Como** desarrollador **quiero** obtener las fechas de irrigación atraves de la API **para** mostrar los datos en la aplicación|<p>**Escenario 1: Obtener informacion de la fecha de irrigación**</p><p>**Dado que** el endpoint "api/v1/irrigation/{agriculturalProcessId} esta disponible</p><p>**Cuando** envia la solicitud GET con los siguientes datos: agriculturalProcessId</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso irrigation con los siguientes datos: irrigationId, date, hour, workers </p>|6|
|E6-US114|Eliminar fechas de irrigación atraves de la APIRESTful|**Como** desarrollador **quiero** eliminar fechas de irrigación atraves de la API **para** eliminar los datos en la aplicación|<p>**Escenario 1: Eliminar fechas de irrigación**</p><p>**Dado que** el endpoint "api/v1/irrigation/{irrigationId} esta disponible</p><p>**Cuando** envia la solicitud DELETE con los siguientes datos: id</p><p>**Entonces** recibe una respuesta con estado 200 con el mensaje "La fecha de irrigacion ha sido eliminada exitosamente"</p>|6|
|E6-US115|Agregar fechas de tratamiento atraves de la APIRESTful|**Como** desarrollador **quiero** agregar fechas de tratamiento atraves de la API **para** registrarlo en la base de datos|<p>**Escenario 1: Agregar fechas de Fertilización**</p><p>**Dado que** el endpoint "api/v1/treatment/fertilization esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: dia, horas, tipo(fertilizacion), productos, costo de productos, trabajadores, costo de trabajadores</p><p>**Entonces** recibe una respuesta con estado 201 con el mensaje "La fecha de fertilizacion ha sido creada exitosamente"</p><p>**Escenario 2: Agregar fechas de Fumigación**</p><p>**Dado que** el endpoint "api/v1/treatment/fumigation esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: dia, horas, tipo(fumigacion), productos, costo de productos, trabajadores, costo de trabajadores</p><p>**Entonces** recibe una respuesta con estado 201 con el mensaje "La fecha de fumigación ha sido creada exitosamente"</p>|6|
|E6-US116|Obtener fechas de tratamiento atraves de la APIRESTful|**Como** desarrollador **quiero** obtener las fechas de irrigación atraves de la API **para** mostrar los datos en la aplicación|<p>**Escenario 1: Obtener informacion de la fechas de tratamiento**</p><p>**Dado que** el endpoint "api/v1/treatment/{agriculturalProcessId} esta disponible</p><p>**Cuando** envia la solicitud GET con los siguientes datos: agriculturalProcessId</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso treatment con los siguientes datos: treatmentId, date, hour, type, workers </p>|6|
|E6-US117|Eliminar fechas de tratamiento|**Como** desarrollador **quiero** eliminar fechas de irrigación atraves de la API **para** eliminar los datos en la aplicación|<p>**Escenario 1: Eliminar fechas de tratamiento**</p><p>**Dado que** el endpoint "api/v1/treatment/{treatmentId} esta disponible</p><p>**Cuando** envia la solicitud DELETE con los siguientes datos: id</p><p>**Entonces** recibe una respuesta con estado 200 con el mensaje "La fecha de tratamiento ha sido eliminada exitosamente"</p>|6|
|E6-US118|Crear fechas de cosecha atraves de la APIRESTful|**Como** desarrollador **quiero** crear fechas de cosecha atraves de la API **para** registrarlo en la base de datos|<p>**Escenario 1: Crear fechas de cosecha**</p><p>**Dado que** el endpoint "api/v1/harvest esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: agriculturalProcessId,nombre, fecha de cosecha, peso, precio por peso</p><p>**Entonces** recibe una respuesta con estado 201 con el mensaje "La fecha de cosecha ha sido creada exitosamente"</p>|6|
|E6-US119|Obtener fechas de cosecha atraves de la APIRESTful|**Como** desarrollador **quiero** obtener las fechas de irrigación atraves de la API **para** mostrar los datos en la aplicación|<p>**Escenario 1: Obtener informacion de la fechas de tratamiento**</p><p>**Dado que** el endpoint "api/v1/treatment/{agriculturalProcessId} esta disponible</p><p>**Cuando** envia la solicitud GET con los siguientes datos: agriculturalProcessId</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso treatment con los siguientes datos: harvestId, nombre de semilla, fecha de cosecha, peso, precio por peso </p>|6|
|E6-US120|Eliminar fechas de cosecha atraves de la APIRESTful|**Como** desarrollador **quiero** eliminar fechas de cosecha atraves de la API **para** eliminar los datos en la aplicación|<p>**Escenario 1: Eliminar fechas de cosecha**</p><p>**Dado que** el endpoint "api/v1/harvest/{harvestId} esta disponible</p><p>**Cuando** envia la solicitud DELETE con los siguientes datos: id</p><p>**Entonces** recibe una respuesta con estado 200 con el mensaje "La fecha de cosecha ha sido eliminada exitosamente"</p>|6|
|E6-US121|Crear fechas de financiamiento atraves de la APIRESTful|**Como** desarrollador **quiero** crear fechas de financiamiento atraves de la API **para** registrarlo en la base de datos|<p>**Escenario 1: Crear fechas de financiamiento**</p><p>**Dado que** el endpoint "api/v1/finances esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: agriculturalProcessId, fecha de financiamiento, costo total, ingresos totales, ganacia</p><p>**Entonces** recibe una respuesta con estado 201 con el mensaje "La fecha de financiamiento ha sido creada exitosamente"</p>|6|
...
|E6-US123|Eliminar fechas de financiamiento atraves de la APIRESTful|**Como** desarrollador **quiero** eliminar fechas de financiamiento atraves de la API **para** eliminar los datos en la aplicación|<p>**Escenario 1: Eliminar fechas de cosecha**</p><p>**Dado que** el endpoint "api/v1/finances/{financesId} esta disponible</p><p>**Cuando** envia la solicitud DELETE con los siguientes datos: id</p><p>**Entonces** recibe una respuesta con estado 200 con el mensaje "La fecha de financiamiento ha sido eliminada exitosamente"</p>|6|
