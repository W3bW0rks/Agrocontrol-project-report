...
|E6-US112|Crear fechas de irrigación atraves de la APIRESTful|**Como** desarrollador **quiero** crear fechas de irrigación atraves de la API **para** registrarlo en la base de datos|<p>**Escenario 1: Crear fechas de irrigación**</p><p>**Dado que** el endpoint "api/v1/irrigation esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: agriculturalProcessId, date, hours, workers, cost</p><p>**Entonces** recibe una respuesta con estado 201 con el mensaje "La fecha de creacion ha sido creada exitosamente"</p>|6|
