...
|E6-US100|Crear API Fake|**Como** desarrollador **quiero** crear una API fake **para** poder avanzar el desarrollo de la web app|<p>**Escenario 1: Creación de la API Fake**</p><p>**Dado que** desarrollador crea una API Fake</p><p>**Cuando** realice el consumo del API Fake</p><p>**Entonces** recibe datos simulados correctamente desde la API Fake y puede usarlos para desarrollar la web app </p>|6|
