...
|E6-TS125|Crear producto|**Como** desarrollador **quiero** crear productos atraves de la API **para** registrarlo en la base de datos|<p>**Escenario 1: Crear productos**</p><p>**Dado que** el endpoint "api/v1/products esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes atributos: userId, name, quantityPerUnit, unitPrice, quantity, photoUrl</p><p>**Entonces** recibe una respuesta con estado 201 con el mensaje "La fecha de financiamiento ha sido creada exitosamente"</p>|6|
